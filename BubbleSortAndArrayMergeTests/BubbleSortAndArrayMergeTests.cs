...
namespace BubbleSortAndArrayMergeTests
{
    ...
    {
        new object[] { new int[] { 1, 3, 5, 9 }, new int[] { 2, 5, 8, 9 }, new int[] { 1, 2, 3, 5, 5, 8, 9, 9 } },
        // add more test cases here
    };

        [TestCaseSource("TestCases")]
        public void GivenTwoNonEmptyArraysOfSameSize_ArrayMergeReturnsSortedCombinedArray(int[] arrOne, int[] arrTwo, int[] expResult)
        {
